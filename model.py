# -- coding: utf-8 --
# @Time: 2022-09-19 22:51
# @Author: WangCx
# @File: new3
# @Project: HyconvE_JF_20_10
# -- coding: utf-8 --
# @Time: 2022-07-29 18:53
# @Author: WangCx
# @File: new
# @Project: HypergraphNN_test2_prior_pos_7
# -- coding: utf-8 --
# @Time: 2022-09-19 22:51
# @Author: WangCx
# @File: new3
...
class HyConvE(BaseClass):
    ...
    def __init__(self, dataset, emb_dim, emb_dim1):
        ...
        # self.pos_emb = PositionalEncoding(self.emb_dim, device=self.dataset.device)



        self.conv_layer_2 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 3))
        self.conv_layer_3 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 4))
        self.conv_layer_4 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 5))
        self.conv_layer_5 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 6))
        self.conv_layer_6 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 7))
        self.conv_layer_7 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 8))
        self.conv_layer_8 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 9))
        self.conv_layer_9 = nn.Conv3d(in_channels=1, out_channels=4, kernel_size=(1, 1, 10))
        ...
        self.conv_size = (self.emb_dim1 * self.emb_dim2) * 4 // 2
        self.conv_size_1d = (self.emb_dim) * 3 // 4
    ...
    def conv2d_process(self, batch):
        if len(batch) == 3:
            ...
            # re1 = F.conv2d(e1, r).view(-1, 1, 1, self.emb_dim)
            # re2 = F.conv2d(e2, r).view(-1, 1, 1, self.emb_dim)
